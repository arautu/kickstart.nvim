...
local config = {
  ...
  cmd = {
    ...
    '-jar',
    vim.env.HOME .. '/.local/share/kvim/mason/share/jdtls/plugins/org.eclipse.equinox.launcher.jar',
    '-configuration',
    '/path/to/jdtls_install_location/config_SYSTEM',
    '-configuration',
    vim.env.HOME .. '/.local/share/kvim/mason/packages/jdtls/config_linux',
